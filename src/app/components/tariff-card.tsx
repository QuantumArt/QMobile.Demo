...
const TariffCard = ({
  ...
  <div className="tariff-card">
    ...
    <div className="tariff-card__content">
      ...
      <p className="tariff-card__traffic-limit">{internetTrafic} ГБ</p>
      <p className="tariff-card__traffic-limit">{mobileTraffic} минут</p>
      ...
      <div className="tariff-card__connect-container">
        ...
        <div className="tariff-card__connect-btns-container">
          <PrimaryButton text="Подключить" onClick={() => onConnectHandler()} />
          <ConnectDetails link="" />
        </div>
      </div>
    </div>
